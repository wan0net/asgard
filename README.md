...
| [![Mimir avatar](docs/assets/avatars/mimir.png)](docs/gods/mimir.md) | [Mimir](docs/gods/mimir.md) | Organizes canonical knowledge with PARA contexts and typed records, with a rebuildable Mem0 retrieval index. | AFFiNE + controlled indexer + Mem0 |
